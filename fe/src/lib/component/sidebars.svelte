<script lang="ts">
	...
	const navigationItems: NavigationItem[] = [
		...
		{
			name: 'Detail',
			icon: 'M7 7h10M7 11h10M7 15h6M5 4a2 2 0 00-2 2v12a2 2 0 002 2h14a2 2 0 002-2V6a2 2 0 00-2-2H5z'
		},
		{
			name: 'Analisis',
		...
		// },
		{ name: 'Pengguna', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4' },
		{
			name: 'Barang',
